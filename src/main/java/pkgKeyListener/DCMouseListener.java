...
public class DCMouseListener {
    private static DCMouseListener my_instance;
    private double scrollX, scrollY;
    double xPos, yPos, lastY, lastX;
    private boolean mouseButtonPressed[] = new boolean[3];
    private boolean isDragging;

    private DCMouseListener() {
        this.scrollX = 0.0f;
        this.scrollY = 0.0f;
        this.xPos = 0.0f;
        this.yPos = 0.0f;
    ...
    public static DCMouseListener get() {
        if (my_instance == null) {
            my_instance = new DCMouseListener();
        }
        return my_instance;
    }
